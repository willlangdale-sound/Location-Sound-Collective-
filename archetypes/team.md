...
profile_picture: '/img/team/{{ .File.ContentBaseName }}.jpg'
profile_picture_circle: '/img/team/{{ .File.ContentBaseName }}-circle.png'
...
description: "{{ replace .File.ContentBaseName "-" " " | title }} - Professional Sound Recordist at Location Sound Collective"
